...
class ButtonGrid extends StatelessWidget {
  ...
  Widget _trigButton(String text) =>
      _buildShortButton(text: text, onPressed: () => onButtonPressed("$text("));
  ...
  Widget _numberButton(String text) =>
      CustomButton(text: text, onPressed: () => onButtonPressed(text));
  ...
  Widget _functionButton(String text) =>
      CustomButton(text: text, onPressed: () => onButtonPressed(text));

  Widget _decimalButton() =>
      CustomButton(text: ".", onPressed: () => onButtonPressed("."));
  ...
  Widget _logButton(String text) =>
      _buildShortButton(text: text, onPressed: () => onButtonPressed("$text("));

  Widget _constantButton(String text) =>
      _buildShortButton(text: text, onPressed: () => onButtonPressed(text));
  ...
  Widget _parenthesisButton(String text) =>
      _buildShortButton(text: text, onPressed: () => onButtonPressed(text));

  Widget _modButton() =>
      _buildShortButton(text: "mod", onPressed: () => onButtonPressed("mod("));
