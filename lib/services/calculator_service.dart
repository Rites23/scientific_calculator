...
class CalculatorService {
  ...
  static double evaluate(String expression) {
    try {
      ...
      cm.bindFunctionName(
        'arcsin',
        (args) => _inverseTrigFunction('arsin', args[0]),
      );
      cm.bindFunctionName(
        'arccos',
        (args) => _inverseTrigFunction('arcos', args[0]),
      );
      cm.bindFunctionName(
        'arctan',
        (args) => _inverseTrigFunction('artan', args[0]),
      );
      ...
      cm.bindFunctionName(
        'cbrt',
        (args) => math.pow(args[0], 1 / 3).toDouble(),
      );
